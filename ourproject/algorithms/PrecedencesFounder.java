                    ...
                    if (countLock >= 10) {
                        ...
                        if ((te1start - v1.getPathIndex())< (te2start-v2Pi)){    
                            ...
                            if(v2.getID() == V2id) {countLock = 0; prec = false; V2id = -1; debug = " D2";}
                                ...
                                //System.out.println("\u001B[33m" + "R"+v1.getID()+"-R"+v2.getID()+"\t  DeadLock  cross1 - IO VADO + vicino!" + "\u001B[0m");
                            }
                        }
                    }
                }
                   ...
                   if (countLock >= 10) {
                       ...
                       if ((te1start - v1.getPathIndex())< (te2start-v2Pi)){
                            ...
                            if(v2.getID() == V2id) {countLock = 0; prec = false; V2id = -1;debug =" F2";}
                                ...
                                if (countLock == 10) V2id = v2.getID();
                                //System.out.println("\u001B[33m" + "R"+v1.getID()+"-R"+v2.getID()+"\t  DeadLock  cross2 - IO VADO + vicino!" + "\u001B[0m");
                            }
                        }
                   }
